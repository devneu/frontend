export const photos = [
  ...
  {
    img: 'https://www.workandtravelgroup.com/wp-content/uploads/wtg-group-2.jpg',
  },
  {
    img: 'https://www.moneycrashers.com/wp-content/uploads/2018/10/travel-world-map-1068x713.jpg',
  },
];
...
export const attachments = [
  {
    ...
    description: 'how to create a case study',
  },
  {
    name: 'zip',
    img: 'https://www.iconpacks.net/icons/2/free-zip-icon-1519-thumb.png',
    description: 'Project Documents',
  },
  {
    name: 'word',
    img: 'https://www.pngkey.com/png/full/210-2104640_imagen-microsoft-office-365-word-logo.png ',
    description: 'Competitor Analysis Template',
  },
];

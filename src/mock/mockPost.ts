export const createMockPost = (options = {} as any) => ({
  id: options.id || 999,
  img: 'https://dummyimage.com/700x350/dee2e6/6c757d.jpg',
  title: 'DEV-17.com',
  date: 'September 23, 2010',
  text: `Science is an enterprise that should be cherished as an activity of the free human mind. 
